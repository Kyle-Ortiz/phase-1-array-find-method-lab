...
function superbowlWin(footballArray) {
  const didWeWin = footballArray.find((element) => element["result"] === "W");
  console.log(didWeWin);
  if (didWeWin == undefined) {
    return didWeWin;
  } else if (didWeWin["result"] === "W") {
    return didWeWin["year"];
  }
}
superbowlWin(record);
